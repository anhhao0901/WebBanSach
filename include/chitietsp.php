		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-5 col-md-8 single-right-left ">
					...
					<!-- /////////////////////////////////////// -->
					<div class="grid images_3_of_2" style="text-indent:4.5rem;">
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<p class="mb-3">
						...
						<br><label style= "color:#0066FF; font-size:15pt"><b>Tiết Kiệm: <?php echo number_format($row_chitiet['sanpham_gia']-$row_chitiet['sanpham_giakhuyenmai']).'vnđ'; ?></b></label>
					</p>
			...
			<br>
			<div><label style= "color:#0066FF; font-size:14pt">* Giá sản phẩm trên BH BookStore đã bao gồm thuế theo luật hiện hành. Bên cạnh đó, tuỳ vào loại sản phẩm, hình thức và địa chỉ giao hàng mà có thể phát sinh thêm chi phí khác như Phụ phí đóng gói, phí vận chuyển, phụ phí hàng cồng kềnh,...*</label></div>
		</div>
	</div>
	<!-- //Single Page -->
	<?php
